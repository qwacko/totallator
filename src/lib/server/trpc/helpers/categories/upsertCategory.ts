...
import type { createCategoryValidationType } from '$lib/validation/category/createCategoryValidation';
import type { updateCategoryDataValidationType } from '$lib/validation/category/updateCategoryValidation';

import { createGroupSingleTitle, updateGroupSingleTitle } from '../groupSingleHandling';
import type { UpsertActions } from '../types';

export type UpsertCategoryData = createCategoryValidationType | updateCategoryDataValidationType;
