...
import type { CategorySortValidation } from '$lib/validation/category/categorySort';

export const categorySortToOrderBy = (
	input: CategorySortValidation
): Prisma.Enumerable<Prisma.CategoryOrderByWithRelationAndSearchRelevanceInput> | undefined => {
	if (!input) {
