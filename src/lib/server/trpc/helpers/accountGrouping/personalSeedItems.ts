...
export const personalSeedData = {
	...
	incomeAccounts: ['Employer 1', 'Bank Interest', 'Employer 2', 'Initial Value', 'Capital Gains'],
	...
	categories: [],
	categoriesSample: [],
	tags: ['Personal/Personal', 'Property/Property A', 'Property/Property B', 'Personal/Capital'],
	tagsSample: []
} as const;
