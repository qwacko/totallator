...
import type { createTagValidationType } from '$lib/validation/tag/createTagValidation';
import type { updateTagDataValidationType } from '$lib/validation/tag/updateTagValidation';

import { createGroupSingleTitle, updateGroupSingleTitle } from '../groupSingleHandling';
import type { UpsertActions } from '../types';

export type UpsertTagData = createTagValidationType | updateTagDataValidationType;
