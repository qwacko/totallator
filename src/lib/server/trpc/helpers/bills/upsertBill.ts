...
import type { createBillValidationType } from '$lib/validation/bill/createBillValidation';
import type { updateBillDataValidationType } from '$lib/validation/bill/updateBillValidation';

import type { UpsertActions } from '../types';

export type UpsertBillData = createBillValidationType | updateBillDataValidationType;
