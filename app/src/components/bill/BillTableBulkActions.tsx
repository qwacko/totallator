...
import { AccountsReturnType, BillsReturnType } from "src/server/trpc/router/_app";

export const BillTableBulkActions = <T extends unknown>(
  column: HeaderContext<BillsReturnType, T>
) => {
